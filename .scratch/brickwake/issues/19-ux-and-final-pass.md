...
quality), Esc pause menu, tuning pass by headless bot matches and Playwright play
(round length, hits to sink, bot difficulty), performance audit at 12 ships. Then run
